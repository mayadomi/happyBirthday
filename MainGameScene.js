...
var MainGameScene = Phaser.Class ({
    ...
    create: function ()
    {
        ...
        //  It needs to fit tho.... so make it the width of Ricklandia.
        ...
        //  What's Ricklandia without a Rick? Add the little dude.
        ...
        //  Check to see if the Rick dude bumps any candles, if he does, stash them in the collectcandle function.
        candleOverlap = this.physics.add.overlap(player, candles, this.collectcandle, null, this);

        //  But if Rick dude bumps into FIRE! It ouchies.
    ...
    collectcandle: function (player, candle)
    {
        ...
        if ( score >= 0 && score < 37 ) {
            if (candles.countActive(true) === 0) 
            {
                ...
                //  Throw in some fire to spice it up - Rick doesn't like being burnt by fire
        ...
        else if (score = 37)   // Most mature (ಠ_ృ)
        //  Cake time oh yeah~!
        {
            this.gameWon();
    ...
    gameWon: function ()
    {
        ...
        scoreText.setText('Happy Birthday Rick!');
